...
#include "config/v850/v850-opts.h"
...
#ifndef GENERATOR_FILE
  int x_VAR_mspace;
#define x_VAR_mspace do_not_use
#endif
#ifndef GENERATOR_FILE
  int x_VAR_mtda_;
#define x_VAR_mtda_ do_not_use
#endif
#ifndef GENERATOR_FILE
  int x_VAR_mzda_;
...
#define MASK_8BYTE_ALIGN (1 << 0)
#define MASK_US_BIT_SET (1 << 1)
#define MASK_APP_REGS (1 << 2)
#define MASK_BIG_SWITCH (1 << 3)
#define MASK_DEBUG (1 << 4)
#define MASK_DISABLE_CALLT (1 << 5)
#define MASK_EP (1 << 6)
#define MASK_GCC_ABI (1 << 7)
#define MASK_SOFT_FLOAT (1 << 8)
#define MASK_JUMP_TABLES_IN_DATA_SECTION (1 << 9)
#define MASK_LONG_CALLS (1 << 10)
#define MASK_LOOP (1 << 11)
#define MASK_NO_STRICT_ALIGN (1 << 12)
#define MASK_PROLOG_FUNCTION (1 << 13)
#define MASK_RELAX (1 << 14)
#define MASK_SMALL_SLD (1 << 15)
#define MASK_V850 (1 << 16)
#define MASK_V850E (1 << 17)
#define MASK_V850E1 (1 << 18)
#define MASK_V850E2 (1 << 19)
#define MASK_V850E2V3 (1 << 20)
#define MASK_V850E3V5 (1 << 21)

#define TARGET_8BYTE_ALIGN ((target_flags & MASK_8BYTE_ALIGN) != 0)
#define TARGET_8BYTE_ALIGN_P(target_flags) ((target_flags & MASK_8BYTE_ALIGN) != 0)
#define TARGET_US_BIT_SET ((target_flags & MASK_US_BIT_SET) != 0)
#define TARGET_US_BIT_SET_P(target_flags) ((target_flags & MASK_US_BIT_SET) != 0)
...
#define TARGET_BIG_SWITCH_P(target_flags) ((target_flags & MASK_BIG_SWITCH) != 0)
#define TARGET_DEBUG ((target_flags & MASK_DEBUG) != 0)
#define TARGET_DEBUG_P(target_flags) ((target_flags & MASK_DEBUG) != 0)
#define TARGET_DISABLE_CALLT ((target_flags & MASK_DISABLE_CALLT) != 0)
#define TARGET_DISABLE_CALLT_P(target_flags) ((target_flags & MASK_DISABLE_CALLT) != 0)
#define TARGET_EP ((target_flags & MASK_EP) != 0)
#define TARGET_EP_P(target_flags) ((target_flags & MASK_EP) != 0)
...
#define TARGET_JUMP_TABLES_IN_DATA_SECTION_P(target_flags) ((target_flags & MASK_JUMP_TABLES_IN_DATA_SECTION) != 0)
...
#define TARGET_LOOP ((target_flags & MASK_LOOP) != 0)
#define TARGET_LOOP_P(target_flags) ((target_flags & MASK_LOOP) != 0)
#define TARGET_NO_STRICT_ALIGN ((target_flags & MASK_NO_STRICT_ALIGN) != 0)
#define TARGET_NO_STRICT_ALIGN_P(target_flags) ((target_flags & MASK_NO_STRICT_ALIGN) != 0)
#define TARGET_PROLOG_FUNCTION ((target_flags & MASK_PROLOG_FUNCTION) != 0)
#define TARGET_PROLOG_FUNCTION_P(target_flags) ((target_flags & MASK_PROLOG_FUNCTION) != 0)
#define TARGET_RELAX ((target_flags & MASK_RELAX) != 0)
#define TARGET_RELAX_P(target_flags) ((target_flags & MASK_RELAX) != 0)
#define TARGET_SMALL_SLD ((target_flags & MASK_SMALL_SLD) != 0)
#define TARGET_SMALL_SLD_P(target_flags) ((target_flags & MASK_SMALL_SLD) != 0)
#define TARGET_V850 ((target_flags & MASK_V850) != 0)
#define TARGET_V850_P(target_flags) ((target_flags & MASK_V850) != 0)
#define TARGET_V850E ((target_flags & MASK_V850E) != 0)
#define TARGET_V850E_P(target_flags) ((target_flags & MASK_V850E) != 0)
#define TARGET_V850E1 ((target_flags & MASK_V850E1) != 0)
#define TARGET_V850E1_P(target_flags) ((target_flags & MASK_V850E1) != 0)
#define TARGET_V850E2 ((target_flags & MASK_V850E2) != 0)
#define TARGET_V850E2_P(target_flags) ((target_flags & MASK_V850E2) != 0)
#define TARGET_V850E2V3 ((target_flags & MASK_V850E2V3) != 0)
#define TARGET_V850E2V3_P(target_flags) ((target_flags & MASK_V850E2V3) != 0)
#define TARGET_V850E3V5 ((target_flags & MASK_V850E3V5) != 0)
#define TARGET_V850E3V5_P(target_flags) ((target_flags & MASK_V850E3V5) != 0)
...
enum opt_code
{
  ...
  OPT_m8byte_align = 1067,                   /* -m8byte-align */
  OPT_mUS_bit_set = 1068,                    /* -mUS-bit-set */
  OPT_mapp_regs = 1069,                      /* -mapp-regs */
  OPT_mbig_switch = 1070,                    /* -mbig-switch */
  OPT_mdebug = 1071,                         /* -mdebug */
  OPT_mdisable_callt = 1072,                 /* -mdisable-callt */
  OPT_mep = 1073,                            /* -mep */
  OPT_mgcc_abi = 1074,                       /* -mgcc-abi */
  OPT_mghs = 1075,                           /* -mghs */
  OPT_mhard_float = 1076,                    /* -mhard-float */
  OPT_mjump_tables_in_data_section = 1077,   /* -mjump-tables-in-data-section */
  OPT_mlong_calls = 1078,                    /* -mlong-calls */
  OPT_mlong_jumps = 1079,                    /* -mlong-jumps */
  OPT_mloop = 1080,                          /* -mloop */
  OPT_mno_strict_align = 1081,               /* -mno-strict-align */
  OPT_mprolog_function = 1082,               /* -mprolog-function */
  OPT_mrelax = 1083,                         /* -mrelax */
  OPT_mrh850_abi = 1084,                     /* -mrh850-abi */
  /* OPT_msda_ = 1085, */                    /* -msda- */
  OPT_msda_ = 1086,                          /* -msda= */
  OPT_msmall_sld = 1087,                     /* -msmall-sld */
  OPT_msoft_float = 1088,                    /* -msoft-float */
  OPT_mspace = 1089,                         /* -mspace */
  /* OPT_mtda_ = 1090, */                    /* -mtda- */
  OPT_mtda_ = 1091,                          /* -mtda= */
  OPT_mv850 = 1092,                          /* -mv850 */
  OPT_mv850e = 1093,                         /* -mv850e */
  OPT_mv850e1 = 1094,                        /* -mv850e1 */
  OPT_mv850e2 = 1095,                        /* -mv850e2 */
  OPT_mv850e2v3 = 1096,                      /* -mv850e2v3 */
  OPT_mv850e2v4 = 1097,                      /* -mv850e2v4 */
  OPT_mv850e3v5 = 1098,                      /* -mv850e3v5 */
  OPT_mv850es = 1099,                        /* -mv850es */
  /* OPT_mzda_ = 1100, */                    /* -mzda- */
  OPT_mzda_ = 1101,                          /* -mzda= */
  OPT_n = 1102,                              /* -n */
  OPT_no_canonical_prefixes = 1103,          /* -no-canonical-prefixes */
  OPT_no_integrated_cpp = 1104,              /* -no-integrated-cpp */
  OPT_nocpp = 1105,                          /* -nocpp */
  OPT_nodefaultlibs = 1106,                  /* -nodefaultlibs */
  OPT_nostartfiles = 1107,                   /* -nostartfiles */
  OPT_nostdinc = 1108,                       /* -nostdinc */
  OPT_nostdinc__ = 1109,                     /* -nostdinc++ */
  OPT_nostdlib = 1110,                       /* -nostdlib */
  OPT_o = 1111,                              /* -o */
  OPT_p = 1112,                              /* -p */
  OPT_pass_exit_codes = 1113,                /* -pass-exit-codes */
  /* OPT_pedantic = 1114, */                 /* -pedantic */
  OPT_pedantic_errors = 1115,                /* -pedantic-errors */
  OPT_pg = 1116,                             /* -pg */
  OPT_pie = 1117,                            /* -pie */
  OPT_pipe = 1118,                           /* -pipe */
  OPT_print_file_name_ = 1119,               /* -print-file-name= */
  OPT_print_libgcc_file_name = 1120,         /* -print-libgcc-file-name */
  OPT_print_multi_directory = 1121,          /* -print-multi-directory */
  OPT_print_multi_lib = 1122,                /* -print-multi-lib */
  OPT_print_multi_os_directory = 1123,       /* -print-multi-os-directory */
  OPT_print_multiarch = 1124,                /* -print-multiarch */
  OPT_print_objc_runtime_info = 1125,        /* -print-objc-runtime-info */
  OPT_print_prog_name_ = 1126,               /* -print-prog-name= */
  OPT_print_search_dirs = 1127,              /* -print-search-dirs */
  OPT_print_sysroot = 1128,                  /* -print-sysroot */
  OPT_print_sysroot_headers_suffix = 1129,   /* -print-sysroot-headers-suffix */
  OPT_quiet = 1130,                          /* -quiet */
  OPT_r = 1131,                              /* -r */
  OPT_remap = 1132,                          /* -remap */
  OPT_s = 1133,                              /* -s */
  OPT_s_bc_abi = 1134,                       /* -s-bc-abi */
  OPT_save_temps = 1135,                     /* -save-temps */
  OPT_save_temps_ = 1136,                    /* -save-temps= */
  OPT_shared = 1137,                         /* -shared */
  OPT_shared_libgcc = 1138,                  /* -shared-libgcc */
  /* OPT_specs = 1139, */                    /* -specs */
  OPT_specs_ = 1140,                         /* -specs= */
  OPT_static = 1141,                         /* -static */
  OPT_static_libasan = 1142,                 /* -static-libasan */
  OPT_static_libgcc = 1143,                  /* -static-libgcc */
  OPT_static_libgcj = 1144,                  /* -static-libgcj */
  OPT_static_libgfortran = 1145,             /* -static-libgfortran */
  OPT_static_libgo = 1146,                   /* -static-libgo */
  OPT_static_liblsan = 1147,                 /* -static-liblsan */
  OPT_static_libstdc__ = 1148,               /* -static-libstdc++ */
  OPT_static_libtsan = 1149,                 /* -static-libtsan */
  OPT_static_libubsan = 1150,                /* -static-libubsan */
  /* OPT_std_c__03 = 1151, */                /* -std=c++03 */
  /* OPT_std_c__0x = 1152, */                /* -std=c++0x */
  OPT_std_c__11 = 1153,                      /* -std=c++11 */
  /* OPT_std_c__14 = 1154, */                /* -std=c++14 */
  OPT_std_c__1y = 1155,                      /* -std=c++1y */
  OPT_std_c__98 = 1156,                      /* -std=c++98 */
  OPT_std_c11 = 1157,                        /* -std=c11 */
  /* OPT_std_c1x = 1158, */                  /* -std=c1x */
  /* OPT_std_c89 = 1159, */                  /* -std=c89 */
  OPT_std_c90 = 1160,                        /* -std=c90 */
  OPT_std_c99 = 1161,                        /* -std=c99 */
  /* OPT_std_c9x = 1162, */                  /* -std=c9x */
  OPT_std_f2003 = 1163,                      /* -std=f2003 */
  OPT_std_f2008 = 1164,                      /* -std=f2008 */
  OPT_std_f2008ts = 1165,                    /* -std=f2008ts */
  OPT_std_f95 = 1166,                        /* -std=f95 */
  OPT_std_gnu = 1167,                        /* -std=gnu */
  /* OPT_std_gnu__03 = 1168, */              /* -std=gnu++03 */
  /* OPT_std_gnu__0x = 1169, */              /* -std=gnu++0x */
  OPT_std_gnu__11 = 1170,                    /* -std=gnu++11 */
  /* OPT_std_gnu__14 = 1171, */              /* -std=gnu++14 */
  OPT_std_gnu__1y = 1172,                    /* -std=gnu++1y */
  OPT_std_gnu__98 = 1173,                    /* -std=gnu++98 */
  OPT_std_gnu11 = 1174,                      /* -std=gnu11 */
  /* OPT_std_gnu1x = 1175, */                /* -std=gnu1x */
  /* OPT_std_gnu89 = 1176, */                /* -std=gnu89 */
  OPT_std_gnu90 = 1177,                      /* -std=gnu90 */
  OPT_std_gnu99 = 1178,                      /* -std=gnu99 */
  /* OPT_std_gnu9x = 1179, */                /* -std=gnu9x */
  /* OPT_std_iso9899_1990 = 1180, */         /* -std=iso9899:1990 */
  OPT_std_iso9899_199409 = 1181,             /* -std=iso9899:199409 */
  /* OPT_std_iso9899_1999 = 1182, */         /* -std=iso9899:1999 */
  /* OPT_std_iso9899_199x = 1183, */         /* -std=iso9899:199x */
  /* OPT_std_iso9899_2011 = 1184, */         /* -std=iso9899:2011 */
  OPT_std_legacy = 1185,                     /* -std=legacy */
  OPT_symbolic = 1186,                       /* -symbolic */
  OPT_t = 1187,                              /* -t */
  OPT_time = 1188,                           /* -time */
  OPT_time_ = 1189,                          /* -time= */
  OPT_traditional = 1190,                    /* -traditional */
  OPT_traditional_cpp = 1191,                /* -traditional-cpp */
  OPT_trigraphs = 1192,                      /* -trigraphs */
  OPT_u = 1193,                              /* -u */
  OPT_undef = 1194,                          /* -undef */
  OPT_v = 1195,                              /* -v */
  OPT_version = 1196,                        /* -version */
  OPT_w = 1197,                              /* -w */
  OPT_wrapper = 1198,                        /* -wrapper */
  OPT_x = 1199,                              /* -x */
  OPT_z = 1200,                              /* -z */
  N_OPTS,
  OPT_SPECIAL_unknown,
