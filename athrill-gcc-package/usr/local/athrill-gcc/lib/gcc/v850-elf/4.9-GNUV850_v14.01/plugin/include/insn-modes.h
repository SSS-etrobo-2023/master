/* Generated automatically from machmode.def and config/v850/v850-modes.def
   by genmodes.  */
...
enum machine_mode
{
  ...
  CC_FPU_LTmode,           /* config/v850/v850-modes.def:21 */
  CC_FPU_LEmode,           /* config/v850/v850-modes.def:22 */
  CC_FPU_GTmode,           /* config/v850/v850-modes.def:23 */
  CC_FPU_GEmode,           /* config/v850/v850-modes.def:24 */
  CC_FPU_EQmode,           /* config/v850/v850-modes.def:25 */
  CC_FPU_NEmode,           /* config/v850/v850-modes.def:26 */
