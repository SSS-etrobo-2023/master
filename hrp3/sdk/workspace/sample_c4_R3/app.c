...
赤ブロック　赤パターン上の時
*/
int matrix_order_on_red[]={ turn_right,
                            move_forward,
                            get_red_block
};
...
赤ブロック　黄パターン上の時
*/
int matrix_order_on_yellow[]={move_forward,
                              move_forward,
                              get_red_block
};
...
赤ブロック　青パターン上の時
*/
int approach_to_goal_order_on_blue[]=  {move_forward,
                                        move_forward,
                                        move_on_white_zone,
                                        turn_right,
                                        move_to_goal
...
赤ブロック　赤パターン上の時
*/
int approach_to_goal_order_on_red[]=    {turn_left,
                                        move_forward,
                                        move_forward,
                                        move_forward,
                                        turn_left,
...
赤ブロック　黄パターン上の時
*/
int approach_to_goal_order_on_yellow[]={move_forward,
                                        move_on_white_zone,
                                        turn_right,
                                        move_to_goal
