    ...
    */
    while(1)
    {
        ...
        else
        {
            ...
            read_color=ev3_color_sensor_get_color(color_sensor);

            switch(read_color){
                case COLOR_BLACK:
                    LOG_D_DEBUG("color= black\n");
                    break;

                case COLOR_WHITE:
                    LOG_D_DEBUG("color= white\n");
                    break;

                case COLOR_YELLOW:
                    LOG_D_DEBUG("color= yellow\n");
                    break;

                case COLOR_RED:
                    LOG_D_DEBUG("color= red\n");
                    break;
                
                case COLOR_BLUE:
                    LOG_D_DEBUG("color= blue\n");
                    break;

                case COLOR_GREEN:
                    LOG_D_DEBUG("color= green\n");
                    break;

                default:
                    LOG_D_DEBUG("color= default\n");
                    break;
        ...
        //ev3_motor_rotate(left_motor, 261, 60, true);
