...
赤ブロック　青パターン上の時
*/
int matrix_order_on_blue[]={move_forward,
                            push_blue_block,
                            turn_right,
                            move_forward,
                            turn_left,
...
赤ブロック　緑パターン上の時
*/
int matrix_order_on_green[]={move_forward,
                            push_blue_block,
                            turn_right,
                            move_forward,
                            turn_right,
...
赤ブロック　赤パターン上の時
*/
int approach_to_goal_order_on_red[] = { turn_right,
                                        move_forward,
                                        move_forward,
                                        move_on_white_zone,
                                        turn_left,
...
赤ブロック　青パターン上の時
*/
int approach_to_goal_order_on_blue[] = {turn_left,
                                        move_forward,
                                        move_forward,
                                        move_forward,
                                        move_on_white_zone,
