    ...
    */
    while(1)
    {
        ...
        if(COURSE_TYPE){
            ...
            if(turn_mode==1){
                ev3_motor_rotate(left_motor,  20, 80, false);
                ev3_motor_rotate(right_motor, 25, 80, false);

            }else if(turn_mode==0){

                ev3_motor_rotate(right_motor, 10, 30, false);
                ev3_motor_rotate(left_motor, 60, 40, true);
        ...
        //左回り
            ...
            if(turn_mode==1){
                ev3_motor_rotate(right_motor, 20, 40, false);
                ev3_motor_rotate(left_motor, 20, 40, true);

            }else if(turn_mode==0){

                ev3_motor_rotate(left_motor, 10, 30, false);
                ev3_motor_rotate(right_motor, 60, 40, true);

            }

        }
        
        tslp_tsk(2 * 100U); /* 0.4msec周期起動 */
