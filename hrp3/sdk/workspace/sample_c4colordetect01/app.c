...
/**/
#define THRE_B_OF_WHITE 45
#define THRE_G_OF_WHITE 45
#define THRE_R_OF_WHITE 45
...
int ret_color_code(){
    ...
    if(read_rgb.r<THRE_R_OF_BLUE && read_rgb.g<THRE_G_OF_BLUE && read_rgb.b>THRE_B_OF_BLUE){
        //青の時
        ret= COLOR_CODE_BLUE;
