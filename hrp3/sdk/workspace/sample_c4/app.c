...
//                float Kp = 10;
  //              float Kd = 0;
        ...
        //   forward = 40; /* 前進命令 */
            ...
            //sensor_reflect は今のsensorの値
            //sensor_diffは平均値
            //sensor_dtは(e - e_pre) eはsensor_diff から sensor_reflectをひいたもの
            ...
            //LOG_D_DEBUG("sensor_dt: %f\nsensor_dt_pre%f\n",
            //            sensor_dt, sensor_dt_pre);
            //青かどうかの判定
